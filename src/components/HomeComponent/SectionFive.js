                                ...
                                <div className="elementor-widget-container">
                                  <section className="vs-team-wrapper">
                                    <div className="container">
                                      <div className="row vs-carousel" data-slick-arrows="false" data-slick-autoplay="false" data-slide-to-show={4}>
                                        <div className="col-md-6 col-lg-4 col-xl-3 ">
                                          <div className="team-style1 ">
                                            <div className="team-img">
                                              <a href><img decoding="async" src="images/default.jpg" alt="t 1 1" /></a>
                                              <div className="team-social">
                                                <a target="_blank" rel="nofollow" href="http://www.facebook.com"><i className="fab fa-facebook-f" /></a><a target="_blank" rel="nofollow" href="http://www.twitter.com"><i className="fab fa-twitter" /></a><a target="_blank" rel="nofollow" href="http://www.instagram.com"><i className="fab fa-instagram" /></a><a target="_blank" rel="nofollow" href="http://www.linkedin.com"><i className="fab fa-linkedin-in" /></a><a target="_blank" rel="nofollow" href="http://www.dribble.com"><i className="fab fa-dribbble" /></a>
                                              </div>
                                            </div>
                                            <div className="team-content">
                                              <h3 className="team-title">
                                                <a className="text-inherit" href>Daniel
                                                  Matthew</a>
                                              </h3>
                                        ...
                                        <div className="col-md-6 col-lg-4 col-xl-3 ">
                                          <div className="team-style1 ">
                                            <div className="team-img">
                                              <a href><img decoding="async" src="images/default.jpg" alt="t 1 2" /></a>
                                              <div className="team-social">
                                                <a target="_blank" rel="nofollow" href="http://www.facebook.com"><i className="fab fa-facebook-f" /></a><a target="_blank" rel="nofollow" href="http://www.twitter.com"><i className="fab fa-twitter" /></a><a target="_blank" rel="nofollow" href="http://www.instagram.com"><i className="fab fa-instagram" /></a><a target="_blank" rel="nofollow" href="http://www.linkedin.com"><i className="fab fa-linkedin-in" /></a><a target="_blank" rel="nofollow" href="http://www.dribble.com"><i className="fab fa-dribbble" /></a>
                                              </div>
                                            </div>
                                            <div className="team-content">
                                              <h3 className="team-title">
                                                <a className="text-inherit" href>Grayson
                                                  Gabriel</a>
                                              </h3>
                                              <p className="team-degi">
                                                Head Manager
                                        ...
                                        <div className="col-md-6 col-lg-4 col-xl-3 ">
                                          <div className="team-style1 ">
                                            <div className="team-img">
                                              <a href><img decoding="async" src="images/default.jpg" alt="t 1 3" /></a>
                                              <div className="team-social">
                                                <a target="_blank" rel="nofollow" href="http://www.facebook.com"><i className="fab fa-facebook-f" /></a><a target="_blank" rel="nofollow" href="http://www.twitter.com"><i className="fab fa-twitter" /></a><a target="_blank" rel="nofollow" href="http://www.instagram.com"><i className="fab fa-instagram" /></a><a target="_blank" rel="nofollow" href="http://www.linkedin.com"><i className="fab fa-linkedin-in" /></a><a target="_blank" rel="nofollow" href="http://www.dribble.com"><i className="fab fa-dribbble" /></a>
                                              </div>
                                            </div>
                                            <div className="team-content">
                                              <h3 className="team-title">
                                                <a className="text-inherit" href>Alexander
                                                  Mason</a>
                                              </h3>
                                              <p className="team-degi">
                                                Founder
                                        ...
                                        <div className="col-md-6 col-lg-4 col-xl-3 ">
                                          <div className="team-style1 ">
                                            <div className="team-img">
                                              <a href><img decoding="async" src="images/t-1-4.jpg" alt="t 1 4" /></a>
                                              <div className="team-social">
                                                <a target="_blank" rel="nofollow" href="http://www.facebook.com"><i className="fab fa-facebook-f" /></a><a target="_blank" rel="nofollow" href="http://www.twitter.com"><i className="fab fa-twitter" /></a><a target="_blank" rel="nofollow" href="http://www.instagram.com"><i className="fab fa-instagram" /></a><a target="_blank" rel="nofollow" href="http://www.linkedin.com"><i className="fab fa-linkedin-in" /></a><a target="_blank" rel="nofollow" href="http://www.dribble.com"><i className="fab fa-dribbble" /></a>
                                              </div>
                                            </div>
                                            <div className="team-content">
                                              <h3 className="team-title">
                                                <a className="text-inherit" href>Maverick
                                                  Cameron</a>
                                              </h3>
                                              <p className="team-degi">
                                                Pro
                                        ...
                                        <div className="col-md-6 col-lg-4 col-xl-3 ">
                                          <div className="team-style1 ">
                                            <div className="team-img">
                                              <a href><img decoding="async" src="images/t-1-5.jpg" alt="t 1 5" /></a>
                                              <div className="team-social">
                                                <a target="_blank" rel="nofollow" href="http://www.facebook.com"><i className="fab fa-facebook-f" /></a><a target="_blank" rel="nofollow" href="http://www.twitter.com"><i className="fab fa-twitter" /></a><a target="_blank" rel="nofollow" href="http://www.instagram.com"><i className="fab fa-instagram" /></a><a target="_blank" rel="nofollow" href="http://www.linkedin.com"><i className="fab fa-linkedin-in" /></a><a target="_blank" rel="nofollow" href="http://www.dribble.com"><i className="fab fa-dribbble" /></a>
                                              </div>
                                            </div>
                                            <div className="team-content">
                                              <h3 className="team-title">
                                                <a className="text-inherit" href>Marian
                                                  Widjya</a>
                                              </h3>
                                              <p className="team-degi">
                                                Lead
